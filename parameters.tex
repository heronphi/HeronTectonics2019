...
{\it Value:} output-HeronTectonics19-M1
...
{\it Value:} angle\_hor=45, pi=3.14159265359, scar\_wid=10e3, angle\_vert = 45, scar\_len = 50e3, ylim1=300e3, ylim2= 500.e3, xlim1=300e3, xlim2 = 500e3
...
{\it Value:} 0; if(z>=580.e3, 1, 0); if(z<580.e3 \&\& z>=570.e3, 1, 0); if(z<570.e3 \&\& z>=480.e3,1, 0); if(z<480.e3 \&\& z>-200.e3,1, 0); if(z<568.e3 \&\& z>548.e3 \&\& (y>=ylim1 \&\& y<ylim2 \&\& (x<xlim2 \&\& (x>=(xlim1+(568e3-z)*tan(angle\_hor*(pi/180))+(y-ylim1)*(tan(angle\_vert*(pi/180)))) \&\& (x<(xlim1+(scar\_wid)+(568e3-z)*tan(angle\_hor*(pi/180))+(y-ylim1)*(tan(angle\_vert*(pi/180)))))))) ||  (z<568.e3 \&\& z>548.e3 \&\& x>=xlim2 \&\& x<(xlim2+150e3) \&\& y>=(ylim2-scar\_wid-(568e3-z)*tan(angle\_hor*(pi/180))) \&\& y<(ylim2-(568e3-z)*tan(angle\_hor*(pi/180)))) || (z<568.e3 \&\& z>548.e3 \&\& y<(ylim1) \&\& y>=(ylim1-150e3) \&\& x>=((xlim1)+(568e3-z)*tan(angle\_hor*(pi/180))+(ylim1-y)*(tan(0*(pi/180)))) \&\& x<(xlim1+scar\_wid+(568e3-z)*tan(angle\_hor*(pi/180))+(ylim1-y)*(tan(0*(pi/180))))),1,0);
